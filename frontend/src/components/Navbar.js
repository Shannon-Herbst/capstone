        ...
        <header>
            <div className="navbar-container">
                ...
                <div className='rightnav'>
                    <Link to={isLoggedIn ? '/my-listings' : '/login?redirect=/my-listings'}>
                        Become a host
                    </Link>
                    <CiGlobe />
                    {isLoggedIn && username && (
                    ...
                    <div
                        className={`rightlink-wrapper${menuOpen ? ' is-open' : ''}`}
                        onMouseEnter={() => setMenuOpen(true)}
                        onMouseLeave={() => setMenuOpen(false)}
                    >
                        {isLoggedIn ? (
                            <>
                                <button type='button' className='rightlink'>
                                    <FaBars />
                                    <CgProfile />
                                </button>
                                <div className='rightlink-dropdown'>
                                    <div className='rightlink-dropdown-menu'>
                                        <Link
                                            to='/my-reservations'
                                            className='rightlink-dropdown-link'
